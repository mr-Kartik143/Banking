    ...
    <div className="container">
      ...
      <div className="rightnav">
        <h1>
          ...
          <div class="message">
            <div class="word1">Finance</div>
            <div class="word2">Loans</div>
            <div class="word3">Deposite</div>
          </div>
        </h1>
      </div>
      {/* slider code start */}
      ...
      >
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="5000">
            <img src="img1.jpg" class="d-block w-100 simg" alt="..." />
          </div>
          <div class="carousel-item" data-bs-interval="5000">
            <img src="img2.jpg" class="d-block w-100 simg" alt="..." />
          </div>
          <div class="carousel-item"  data-bs-interval="5000">
            <img src="img6.jpg" class="d-block w-100 simg" alt="..." />
          </div>
        </div>
        <button
      ...
      <div className="container my-1 sdiv">
        ...
        <Link class="nav-link" to="/Transfer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="46"
            height="46"
            fill="currentColor"
            class="bi bi-person-fill csvg mx-2"
            viewBox="0 0 16 16"
          >
        ...
        <Link class="nav-link" to="/tobank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40"
            height="40"
            fill="currentColor"
            class="bi bi-bank bsvg"
            viewBox="0 0 16 16"
          >
        ...
        <Link class="nav-link" to="/selfac">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="43"
            height="43"
            fill="currentColor"
            class="bi bi-file-arrow-down ssvg"
            viewBox="0 0 16 16"
          >
        ...
        <Link class="nav-link" to="/blac">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="42"
            height="42"
            fill="currentColor"
            class="bi bi-bank2 blsvg"
            viewBox="0 0 16 16"
          >
      ...
      <div className="container my-5">
        <Link class="nav-link" to="/wallet">
          <svg
            ...
            height="48"
            fill="currentColor"
            class="bi bi-credit-card walletdiv1 mt-4"
            viewBox="0 0 16 16"
          >
        ...
        <Link class="nav-link" to="/rewards">
          <svg
            ...
            height="46"
            fill="currentColor"
            class="bi bi-gift walletdiv2 mt-4"
            viewBox="0 0 16 16"
          >
        ...
        <Link class="nav-link" to="/refer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="46"
            height="46"
            fill="currentColor"
            class="bi bi-megaphone walletdiv3 mt-4"
            viewBox="0 0 16 16"
          >
      ...
      <div className="container">
        ...
        <a href="https://www.zomato.com/">
          <img className="m-3 app1" src="zomato.png" alt="img not found" />
          <small className="S fw-bolder text-wrap sm8 mt-4">Zomato</small>
        </a>
        <a href="https://www.flipkart.com/">
        <img className="m-3 app2" src="Flipkart.png" alt="img not found" />
        <small className="S fw-bolder text-wrap sm9 mt-4">Flipkart</small>
        </a>
        <a href="https://www.facebook.com/">
        <img className="m-3 app3" src="facebook.png" alt="img not found" />
